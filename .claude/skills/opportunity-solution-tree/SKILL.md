...
description: Structure product discovery with Teresa Torres' Opportunity Solution Tree - outcome, opportunities, solutions, experiments
argument-hint: "[desired outcome]"
---

<!--
This skill is ported from phuryn/pm-skills under the MIT License.
Copyright (c) 2026 Pawel Huryn.
Upstream: https://github.com/phuryn/pm-skills/blob/main/pm-product-discovery/skills/opportunity-solution-tree/SKILL.md
See ./ATTRIBUTION.md for the full license text.
-->
